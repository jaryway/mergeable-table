...
exports.range2Cells = range2Cells;
exports.getLineCells = getLineCells;
exports.getRange = getRange;
exports.getMergedPlace = getMergedPlace;
exports.getCellsRange = getCellsRange;
...
function range2Cells(cell1, cell2) {
  var _ref = cell1 || [],
...
function getLineCells(cell1, cell2) {
...
function getCellsRange(cell1, cell2) {
  var mergedCells = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
  var placeCells = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};
