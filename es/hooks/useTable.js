...
var useTable = function useTable(config, onChange) {
  ...
  var onCellMouseLeftDown = useCallback(function (i, j) {
    return function () {
      // e.preventDefault();
      var _getCellRange = getCellRange([i, j], memoizedMergedCells, memoizedPlaceCells),
  ...
  var onCellMouseOver = useCallback(function (i, j) {
    return function (_e) {
      ...
      var next = [[m, n], [i, j]];
      var maxRange = getRange.apply(void 0, next.concat([memoizedMergedCells, memoizedPlaceCells]));
      setSelection(next);
      setRange(maxRange);
      setSelectedCells(range2Cells.apply(void 0, _toConsumableArray(maxRange))); // console.log('onCellMouseOver', maxRange, next);
    };
  ...
  var onMergeCell = useCallback(function () {
    ...
    var changedValue = _extends(_extends({}, config), {
      elements: update(nextData, command)
    });
  ...
  var onSplitCell = useCallback(function (cell) {
    ...
    onChange && onChange(_extends(_extends({}, config), {
      elements: update(config.elements, command)
  ...
  var getOverlay = useCallback(function (cell) {
    ...
    }, "\u5408\u5E76\u5355\u5143\u683C"), React.createElement(_Menu.Item, {
      key: "split",
      disabled: !canSplit
    }, "\u62C6\u5206\u5355\u5143\u683C"), React.createElement(_Menu.Divider, {
      key: "d1"
    }), React.createElement(_Menu.Item, {
      key: "addrow"
    }, "\u6DFB\u52A0\u884C"), React.createElement(_Menu.Item, {
      key: "delrow"
    }, "\u5220\u9664\u884C"), React.createElement(_Menu.Divider, {
      key: "d2"
    }), React.createElement(_Menu.Item, {
      key: "addcol"
    }, "\u6DFB\u52A0\u5217"), React.createElement(_Menu.Item, {
      key: "delcol"
    }, "\u5220\u9664\u5217"), React.createElement(_Menu.Divider, {
      key: "d3"
    }), React.createElement(_Menu.Item, {
      key: "clean"
    }, "\u6E05\u7A7A\u9009\u62E9"));
